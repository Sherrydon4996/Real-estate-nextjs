...
<div style="font-family: Arial, sans-serif; background-color: #f8f9fa; padding: 0; max-width: 600px; margin: auto; color: #333; border: 1px solid #e9ecef;">
  ...
  <div style="background-color: #007bff; padding: 25px; text-align: center;">
    <h1 style="color: white; margin: 0; font-size: 28px; letter-spacing: 1px;">PRESTIGE</h1>
    <p style="color: #e6f3ff; margin: 5px 0 0; font-size: 14px; letter-spacing: 2px;">PROPERTIES</p>
  </div>
  
  <!-- Content area -->
  <div style="padding: 30px;">
    <h2 style="text-align: center; color: #007bff; margin-bottom: 25px; font-size: 22px; border-bottom: 1px solid #e9ecef; padding-bottom: 15px;">🏠 New Client Enquiry 🏠</h2>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 25px;">
      ...
      <tr>
        <td style="padding: 12px 10px; font-weight: 600; color: #007bff;">Subject:</td>
        <td style="padding: 12px 10px; border-bottom: 1px solid #e9ecef;">${
    ...
    <div style="text-align: center; margin-top: 30px;">
      <a href="mailto:${email}" style="background-color: #007bff; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: 600; display: inline-block; letter-spacing: 1px;">Reply to Client</a>
    </div>
  </div>
  
  <!-- Footer -->
  <div style="background-color: #007bff; padding: 20px; text-align: center; font-size: 12px; color: white;">
    <p style="margin: 0;">Prestige Properties • Your Dream Home Awaits • <a href="https://prestigeproperties.com" style="color: #e6f3ff; text-decoration: none;">prestigeproperties.com</a></p>
  </div>
</div>
`,
      }),
